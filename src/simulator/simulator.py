'''
generating the paths of Brownian Motion or Brownian Bridge for process:
...
class EulerMaruyamaSimulator(Simulator):
    ...
    def step(self, xt: torch.Tensor, t: torch.Tensor, h: torch.Tensor):
        return xt + self.sde.drift_coefficient(xt, t) * h + self.sde.diffusion_coefficient(xt, t) * torch.sqrt(
